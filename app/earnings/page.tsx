      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-8 overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-xl dark:border-zinc-800 dark:bg-zinc-900/80 dark:shadow-black/10">
          <div className="border-b border-zinc-200 bg-gradient-to-br from-emerald-500/10 to-transparent p-8 dark:border-zinc-800/80">
            ...
            <div className="mt-2 text-4xl font-bold tracking-tight text-emerald-400">
              ${balance.toFixed(2)}
            </div>
        ...
        {/* Transaction History */}
        <div>
          <h2 className="mb-4 text-lg font-semibold text-zinc-200">Earning history</h2>
          {transactions.length === 0 ? (
            ...
            <div className="space-y-2">
              {transactions.map((tx) => (
                <div
                  key={tx.id}
                  className="flex items-center justify-between rounded-xl border border-zinc-200 bg-white px-5 py-4 transition hover:border-zinc-300 dark:border-zinc-800 dark:bg-zinc-900/60 dark:hover:border-zinc-700"
                >
